...
function calculateSolar() {
    ...
    var feedback="";
    feedback +="<p>Based on your average daily use of "+Math.round(dailyUseKw) +" kWh, you will need to purchase "+ panelsNeeded +" "+ panelName +" brand new solar panels to offset 100% of your electricity bill.</p>";
